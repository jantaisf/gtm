...
| **Cohort** | Sum of account Consumption ACV grouped by contract start quarter and/or account segment (e.g., all Enterprise accounts signed in Q1 FY2025) — see note below |
